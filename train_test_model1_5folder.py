...
def main():
    ...
    for (train_data, train_labels, val_data, val_labels, test_data, test_labels), i in fold_generator:
        ...
        try:
            ...
            model = Sequential()
            model.add(Conv3D(64,(3,3,3),strides=1, padding='same',activation= 'relu',data_format = 'channels_first', input_shape=(4, options['patch_width'], options['patch_width'],options['patch_width'])))
